...
namespace MideaAscm.Dal.Warehouse.Entities
{
    ...
    public class AscmWmsStockTransMain
    {
        ...
        public string createUserName { get; set; }
         /// <summary>最后更新人姓名</summary>
        public string modifyUserName { get; set; }
         /// <summary>来源仓库人员姓名</summary>
        public string fromWarehouseUserName { get; set; }
        /// <summary>目标仓库人员姓名</summary>
        public string toWarehouseUserName { get; set; }
