				...
				<td style="padding:20px 20px 10px 240px;">
		            <table border="0" cellspacing="0" style="width:240px;">
			            <tr style="height:30px;">
				            ...
				            <td style="width:70%;">
                                <%: Html.TextBoxFor(model => model.UserName, new { style = "width:140px;", value = "sa" })%>
			            ...
			            <tr style="height:30px">
				            ...
				            <td>
                                <%: Html.PasswordFor(model => model.Password, new Dictionary<string, object>() { { "style", "width:140px;"},{"value","123"}})%>
