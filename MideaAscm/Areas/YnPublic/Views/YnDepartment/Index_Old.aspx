		...
		<div class="easyui-panel" title="部门管理 " fit="true" border="false">
			<div class="easyui-layout" fit="true">
			    <div region="center" border="false">
                    ...
                    <div id="tb2">
                        单位：<input id="organizationName" type="text" style="width:120px; background-color:#CCCCCC;" readonly="readonly"/>
                        <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" onclick="SelectOrganization();" style=""><img alt='' title="选择" border="0" src='<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Areas/YnPublic/Content/images/ICPROP.gif' width="16" height="13" style=""/></a>
                    ...
                    <%-- 选择单位 --%>
                    <%Html.RenderPartial("~/Areas/YnPublic/Views/YnOrganization/OrganizationSelect.ascx"); %>
                                ...
                                <form id="editDepartmentForm" method="post" style="">
				                    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
					                    <tr style="height:24px">
						                    ...
						                    <td style="width:80%">
                                                <input id="organizationId" name="organizationId" type="text" style="width:0px;display:none"/>
            ...
            $('#dataGridDepartment').treegrid({
				...
				onBeforeLoad: function(row,param){
					if (!row) {	// load top level rows
                        var url = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/YnPublic/YnDepartment/DepartmentList?root=true&oid=' + $('#organizationId').val();
                        $(this).treegrid("options").url = url;
						param.id = 0;	// set id=0, indicate to load new page rows
					}else{
                        var url = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/YnPublic/YnDepartment/DepartmentList?root=false&oid=' + $('#organizationId').val();
                        $(this).treegrid("options").url = url;
                    }
				}
            });
