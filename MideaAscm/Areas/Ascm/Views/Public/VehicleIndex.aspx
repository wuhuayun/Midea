...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div region="center" title="" border="true" style="padding:0px;overflow:auto;">
		<table id="dataGridVehicle" title="美的车辆基本信息管理" style="" border="false" fit="true" singleSelect="true"
			idField="id" sortName="sortNo" sortOrder="asc" striped="true" toolbar="#tb1">
		</table>
        <div id="tb1">
            <input id="vehicleSearch" type="text" style="width:100px;" />
            ...
            <%} %>
            <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" icon="icon-cancel" onclick="Delete();">进出日志</a>
        </div>
                    ...
                    <form id="editVehicleForm" method="post" style="">
				        <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
					        ...
					        <tr style="height:24px">
						        ...
						        <td style="width:80%">
							        <input class="easyui-validatebox" id="Text5" name="startId" type="text" style="width:100px;" />(无限制/条件允许后放行)
						        </td>
					        </tr>
					        <tr style="height:24px">
						        <td style="width: 20%; text-align:right;" nowrap>
...
//                pageSize: 50,
                ...
                columns: [[
                    ...
                    { field: 'name', title: '工号', width: 60, align: 'center' },
                    { field: 'name', title: '车主', width: 60, align: 'center' },
                    { field: 'name', title: '联系方式', width: 60, align: 'center' },
                    { field: 'name', title: '权限(无限制/条件允许后放行)', width: 60, align: 'center' },
