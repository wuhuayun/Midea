...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentScriptAndCss" runat="server">
    ...
    <script type="text/javascript">
        ...
        function refresh() {
            var mycheckRows = $('#dgWipJobsPreparation').datagrid('getChecked');
            $.each(mycheckRows, function (row, i) {
                $('#dgWipJobsPreparation').datagrid('checkRow',i);
            });
        ...
        $(function () {
            ...
            $('#startMaterialDocNumber').keypress(function (e) {
                ...
                if (keyCode == 13) {
                    tagKeypress($('#artMaterialDocNumberst'));
                }
            });
        ...
        function stopJobPreparation()
        {
        	...
        	if (checkRows.length == 0)
        	{
        		$.messager.alert("提示", "请勾选要停止备料确认的作业！", "info");
        		return;
        	}
        	var statusIds = "";
        	$.each(checkRows, function (i, row)
