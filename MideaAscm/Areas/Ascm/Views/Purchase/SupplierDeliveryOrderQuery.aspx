...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div region="center" title="" border="true" style="padding:0px;overflow:auto;">
		<table id="dataGridDeliveryOrder" title="批送货单统计" style="" border="false" fit="true" singleSelect="true"
        ...
        <div id="tb">
			...
			<select id="queryStatus" name="queryStatus" style="width:80px;">
                <option value=""></option>
                <% List<string> listStatusDefine = MideaAscm.Dal.FromErp.Entities.AscmDeliveryOrderMain.StatusDefine.GetSupplierList(); %>
            ...
            <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" icon="icon-print" onclick="DeliveryOrderBatchPrint();">打印统计表</a>
        </div>
	</div>
</asp:Content>
    ...
    <script type="text/javascript">
        $(function () {
            $('#dataGridDeliveryOrder').datagrid({
                //url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Purchase/SupplierDeliveryOrderMainList',
                rownumbers: true,
                pagination: true,
                pageSize: 50,
                view: detailview,
        ...
        function Query() {
            ...
            $('#dataGridDeliveryOrder').datagrid({
                url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Purchase/SupplierDeliveryOrderBatchList'
            });
        }
        var currentId = null;
        function DeliveryOrderBatchPrint() {
            var url = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Areas/Ascm/ReportViewer/SupplierDeliveryOrderBatchPrint.aspx';
            ...
            parent.openTab('供应商批送货单统计打印', url);
        }
    </script>
</asp:Content>
