        ...
        <table id="dgTaskRule" title="任务生成规则管理" class="easyui-datagrid" style="" border="false"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-options="field:'ascmRole_Name',width:90,align:'center'">
                                    指定角色
                                </th>
                        ...
                        <tr style="height: 24px">
                            ...
                            <%-- <td>
                                <input class="easyui-validatebox" id="relatedRanker" name="relatedRanker" type="text"
                                    style="width: 300px;" />
                                    <a href="javascript:void(0);" id="btnEditPerson" class=“easyui-linkbutton" plain="true" iconCls="icon-extract" title="角色编辑" onclick="btnEditPerson();"></a>
                            </td> --%>
                            <td>
                            <span> <%Html.RenderPartial("~/Areas/Ascm/Views/Logistics/roleSelectCombo2.ascx", new MideaAscm.Code.SelectCombo { id="personName2"}); %></span>
    			...
    			$.ajax({
    				...
    				success: function (r)
    				{
    					if (r)
    					{
    						...
    						$('#personName2').combogrid('setValue', r.ascmRole_Name);
