...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div region="center" title="" border="false">
                    <table id="dgMaterialCategory" title="物料大类管理" class="easyui-datagrid" style="" border="false"
                        data-options="fit: true,
                                      ...
                                      pageSize: 50,
                                      loadMsg: '更新数据......',
                                      url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialCategoryList',
                ...
                <div region="center" border="true" fit="true" style="padding: 0px 0px 0px 0px; overflow: false;">
                    <table id="dgMaterialSubCategory" title="物料子类管理" class="easyui-datagrid" style="" border="false"
                        data-options="fit: true,
                          ...
                          pageSize: 50,
                          loadMsg: '更新数据...',
                          <%--url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialSubCategoryList',--%>
                            ...
                            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                                ...
                                <table style="width: 100%;" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr style="height: 24px">
                                        ...
                                        <td>
                                            <select id="zMtlCategoryStatus" name="zMtlCategoryStatus" style="width: 145px;">
                                                <option value=""></option>
                                    ...
                                    <tr style="height: 24px">
                                        ...
                                        <td>
                                            <select id="dMtlCategoryStatus" name="dMtlCategoryStatus" style="width: 145px;">
                                                <option value=""></option>
                                    ...
                                    <tr style="height: 24px">
                                        ...
                                        <td>
                                            <select id="wMtlCategoryStatus" name="wMtlCategoryStatus" style="width: 145px;">
                                                <option value=""></option>
                                                <% listMtlCategoryStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
                                                <% if (listMtlCategoryStatusDefine != null && listMtlCategoryStatusDefine.Count > 0)
                                                   { %>
                                    ...
                                    <tr style="height: 24px">
                                        ...
                                        <td>
                                            <input class="easyui-validatebox" id="tip" name="tip" type="text"
                                                style="width: 300px;" />
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                                ...
                                <table style="width: 100%;" border="0" cellpadding="0" cellspacing="0">
                                    <tr style="height: 24px">
                                        ...
                                        <td>
                                            <select id="cZMtlCategoryStatus" name="zMtlCategoryStatus" style="width: 145px;">
                                                <option value=""></option>
                                    ...
                                    <tr style="height: 24px">
                                        ...
                                        <td>
                                            <select id="cDMtlCategoryStatus" name="dMtlCategoryStatus" style="width: 145px;">
                                                <option value=""></option>
                                                <option value="kz">空值</option>
                                                <% listMtlCategoryStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
                                                <% if (listMtlCategoryStatusDefine != null && listMtlCategoryStatusDefine.Count > 0)
                                    ...
                                    <tr style="height: 24px">
                                        ...
                                        <td>
                                            <select id="cWMtlCategoryStatus" name="wMtlCategoryStatus" style="width: 145px;">
                                                <option value=""></option>
                                                <option value="kz">空值</option>
                                                <% listMtlCategoryStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
                                                <% if (listMtlCategoryStatusDefine != null && listMtlCategoryStatusDefine.Count > 0)
    ...
    <div region="east" split="true" title="" border="false" style="width: 580px; padding: 0px 0px 0px 0px;
        overflow: auto;">
        <div class="easyui-panel" fit="true" border="false" >
            <div class="easyui-layout" fit="true" style="">
                <div region="center" border="true" fit="true" style="padding: 0px 0px 0px 0px; overflow: false;">
                    <table id="dgMaterialItem" title="物料管理" class="easyui-datagrid" style="" border="false"
                        data-options="fit: true,
                          ...
                          loadMsg: '更新数据...',
                          <%--url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialItemList',--%>
                          onSelect: function(rowIndex, rowRec){
                              currentId = rowRec.id;
                          },
                          onDblClickRow: function(rowIndex, rowRec){
...
<script type="text/javascript">
    ...
    function Query_MaterialSubCategory() {
        var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialSubCategoryList/';
    ...
    function Edit_MaterialSubCategory() {
        ...
        if (selectRow) {
            ...
            var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialSubCategoryEdit/' + selectRow.id;
            $.ajax({
                url: sUrl,
                type: "post",
                dataType: "json",
                success: function (r) {
                    if (r) {
                        ...
                        $('#zMtlCategoryStatus').val(r.zMtlCategoryStatus);
                        $('#dMtlCategoryStatus').val(r.dMtlCategoryStatus);
                        $('#wMtlCategoryStatus').val(r.wMtlCategoryStatus);
                        $('#tip').val(r.tip);
                    }
                }
            });
        ...
        $.messager.confirm("确认", "确认提交保存?", function (r) {
            if (r) {
                $('#editMaterialSubCategoryForm').form('submit', {
                    url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialSubCategorySave/' + currentId,
                    onSubmit: function () {
...
<script type="text/javascript">
    ...
    function Query_MaterialItem() {
        var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialItemList/';
    ...
    function Edit_MaterialItem() {
        ...
        if (selectRow) {
            ...
            var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialItemEdit/' + selectRow.id;
            $.ajax({
                url: sUrl,
                type: "post",
                dataType: "json",
        ...
        $.messager.confirm("确认", "确认提交保存?", function (r) {
            if (r) {
                $('#editMaterialItemForm').form('submit', {
                    url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialItemSave/' + currentId,
                    onSubmit: function () {
...
<script type="text/javascript">
    function LoadMaterialSubCategoryList() {
        var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/LoadMaterialSubCategoryList/';
        var options = $('#dgMaterialSubCategory').datagrid('options');
        options.url = sUrl;
    ...
    function LoadMaterialItemList() {
        var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/LoadMaterialItemList/';
        var options = $('#dgMaterialItem').datagrid('options');
        options.url = sUrl;
...
<script type="text/javascript">
    function GetCategoryCode() {
        ...
        if (selectRow) {
            var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/MaterialCategoryEdit/' + selectRow.id;
            $.ajax({
                url: sUrl,
                type: "post",
                dataType: "json",
...
<script type="text/javascript">
    ...
    function Save_Choice_MaterialSubCategory() {
        $.messager.confirm('确认', '确认修改选择的物料子类？', function (result) {
            if (result) {
                var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/ChoiceMaterialSubCategorySave/';
                $.ajax({
                    url: sUrl,
                    type: "post",
                    dataType: "json",
                    data: { "releaseHeaderIds": releaseHeaderIds,
                        "zmtlCategoryStatus": $('#cZMtlCategoryStatus').val(),
                        "dmtlCategoryStatus": $('#cDMtlCategoryStatus').val(),
                        "wmtlCategoryStatus": $('#cWMtlCategoryStatus').val()
                    },
                    success: function (r) {
                        if (r.result) {
