    ...
    <div region="center" title="" border="true" style="padding: 0px; overflow: false;">
        <table id="dgWorkloadStatistics" title="员工任务统计查询" class="easyui-datagrid" style="" border="false"
                        data-options="fit: true,
                          ...
                          pageSize: 50,
                          loadMsg: '更新数据...',
                          url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/WorkloadStatisticsList',
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-options="field:'workerName',width:150,align:'left'">
                                    姓名
                                </th>
...
<script type="text/javascript">
    ...
    function loadTaskDetail(id) {
        ...
        options.queryParams.starTime = currentStartDate;
        options.queryParams.endTime = currentEndDate;
        options.url = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/LoadDetailStatistics';
...
<script type="text/javascript">
    function Search() {
        var options = $('#dgWorkloadStatistics').datagrid('options');
        options.queryParams.starTime = $('#queryStartDate').datebox('getText');
        options.queryParams.endTime = $('#queryEndDate').datebox('getText');
