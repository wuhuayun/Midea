...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div region="center" title="" border="true" style="padding:0px;overflow:auto;">
		<table id="dataGridStockTransfer" title="转仓登记管理" style="" border="false" fit="true" singleSelect="true"
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentScriptAndCss" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Search() {
            var queryParams = $('#dataGridStockTransfer').datagrid('options').queryParams;
            queryParams.queryWord = $('#Search').val();
            $('#dataGridStockTransfer').datagrid('reload');
        }
        var currentId = null;
        function Edit() {
//            var selectRow = $('#dataGridStockTransfer').datagrid('getSelected');
//            if (selectRow) {
var id="123";
//id=selectRow.id;
                var url = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Warehouse/StockTransferEdit/' + id+"?mi=<%=Request["mi"].ToString() %>";
                parent.openTab('转仓单_' + id, url);
