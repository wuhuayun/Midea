    ...
    <div region="center" title="" border="true" style="padding:0px;overflow:false;">
        <table id="dgStockFormat" title="备料形式批量维护" class="easyui-datagrid" style="" border="false"
                        data-options="fit: true,
                          ...
                          loadMsg: '更新数据...',
                          url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/MaterialStockFormatList',
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-options="field:'modifyUser',width:80,align:'left'">
                                    修改人
                                </th>
                                <th data-options="field:'modifyTime',width:120,align:'center'">
                                    修改时间
                                </th>
                            </tr>
                        </thead>
        ...
        <div id="tb1">
            <div style="margin-bottom:5px;margin-top:5px;">
                <span>总装备料形式：</span>
                <select id="zStatus" name="zStatus" style="width: 120px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                    ...
                    <% foreach (string statusDefine in mtlStatusDefine)
                        { %>
                        <option value="<%=statusDefine %>"><%=MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.DisplayText(statusDefine)%></option>
                    <% } %>
                    <% } %>
                </select>
                <span>电装备料形式：</span>
                <select id="dStatus" name="dStatus" style="width: 120px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                    <option value="">未维护</option>
                    <option value="kz">空值</option>
                    <option value="qb">全部</option>
                ...
                <span>其他备料形式：</span>
                <select id="wStatus" name="wStatus" style="width: 120px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                    <option value="">未维护</option>
                    <option value="kz">空值</option>
                    <option value="qb">全部</option>
                    <% mtlStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
            ...
            <div style="margin-bottom:5px;">
                <span>　　供应类型：</span>
                <select id="queryType" name="queryType" style="width: 120px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                    <option value="">　</option>
                ...
                <% foreach (int typeDefine in listTypeDefine)
                    ...
                    <%if (typeDefine <= 3 && typeDefine >= 1)
                      { %>
                    <option value="<%=typeDefine %>"><%=MideaAscm.Dal.Base.Entities.AscmMaterialItem.WipSupplyTypeDefine.DisplayText(typeDefine)%></option>
                    <% } %>
                <% } %>
                <% } %>
                </select>
                <span>编码段：</span>
                <input id="queryStarDocnumber" type="text" style="width: 100px;" maxlength="12" onblur="rightPadding('#queryStarDocnumber', 12);" /> - 
                <input id="queryEndDocnumber" type="text" style="width: 100px;" maxlength="12" onblur="rightPadding('#queryEndDocnumber', 12);" />
                <span>描述：</span>
            ...
            <div style="margin-bottom:5px;">
                ...
                <% if (ynWebRight.rightAdd)
                   { %>
                <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" icon="icon-repair"
                ...
                <% if (ynWebRight.rightAdd || ynWebRight.rightEdit){ %>
                    ...
                    <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" icon="icon-remove" onclick="ExportExcel();">导出</a>
                <% } %>
                ...
                <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                    ...
                    <table style="width: 100%;" border="0" cellpadding="0" cellspacing="0">
                        <tr style="height: 24px">
                            ...
                            <td style="width: 80%">
                                <input id="sDocnumber" name="sDocnumber" type="text" style="width: 100px;" maxlength="12" onblur="rightPadding('#sDocnumber', 12);" />-
                                <input id="eDocnumber" name="eDocnumber" type="text" style="width: 100px;" maxlength="12" onblur="rightPadding('#eDocnumber', 12);" />
                            </td>
                        </tr>
                        <tr style="height: 24px">
                            <td style="text-align: right;" nowrap>
                            ...
                            <td>
                                <select id="wipSupplyType" name="wipSupplyType" style="width: 80px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                                    <option value="">　</option>
                        ...
                        <tr style="height: 24px">
                            ...
                            <td>
                                <select id="b_zMtlCategoryStatus" name="zMtlCategoryStatus" style="width: 145px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                                    <option value="">　</option>
                                    <% listMtlCategoryStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
                                    <% if (listMtlCategoryStatusDefine != null && listMtlCategoryStatusDefine.Count > 0)
                                        { %>
                        ...
                        <tr style="height: 24px">
                            ...
                            <td>
                                <select id="b_dMtlCategoryStatus" name="dMtlCategoryStatus" style="width: 145px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                                    <option value="">　</option>
                                    <% listMtlCategoryStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
                                    <% if (listMtlCategoryStatusDefine != null && listMtlCategoryStatusDefine.Count > 0)
                                        { %>
                        ...
                        <tr style="height: 24px">
                            ...
                            <td>
                                <select id="b_wMtlCategoryStatus" name="wMtlCategoryStatus" style="width: 145px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                                    <option value="">　</option>
                                    <% listMtlCategoryStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
                                    <% if (listMtlCategoryStatusDefine != null && listMtlCategoryStatusDefine.Count > 0)
                                        { %>
                ...
                <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                    ...
                    <table style="width: 100%;" border="0" cellpadding="0" cellspacing="0">
                        <tr style="height: 24px">
                            ...
                            <td>
                                <select id="c_zMtlCategoryStatus" name="zMtlCategoryStatus" style="width: 145px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                                    <option value="">　</option>
                                    <% listMtlCategoryStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
                                    <% if (listMtlCategoryStatusDefine != null && listMtlCategoryStatusDefine.Count > 0)
                                        { %>
                        ...
                        <tr style="height: 24px">
                            ...
                            <td>
                                <select id="c_dMtlCategoryStatus" name="dMtlCategoryStatus" style="width: 145px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                                    <option value="">　</option>
                                    <% listMtlCategoryStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
                                    <% if (listMtlCategoryStatusDefine != null && listMtlCategoryStatusDefine.Count > 0)
                                        { %>
                        ...
                        <tr style="height: 24px">
                            ...
                            <td>
                                <select id="c_wMtlCategoryStatus" name="wMtlCategoryStatus" style="width: 145px;" class="easyui-combobox" data-options="panelHeight:'auto'">
                                    <option value="">　</option>
                                    <% listMtlCategoryStatusDefine = MideaAscm.Dal.GetMaterialManage.Entities.MtlCategoryStatusDefine.GetList(); %>
                                    <% if (listMtlCategoryStatusDefine != null && listMtlCategoryStatusDefine.Count > 0)
                                        { %>
...
<script type="text/javascript">
    ...
    function Query() {
        ...
        queryParams.queryType = $('#queryType').combobox('getValue');
        queryParams.queryStarDocnumber = $('#queryStarDocnumber').val();
        queryParams.queryEndDocnumber = $('#queryEndDocnumber').val();
        queryParams.zmtlCategoryStatus = $('#zStatus').combobox('getValue');
        queryParams.dmtlCategoryStatus = $('#dStatus').combobox('getValue');
        queryParams.wmtlCategoryStatus = $('#wStatus').combobox('getValue');
...
<script type="text/javascript">
    function DataRepair() {
        $.messager.confirm('确认', '是否维护物料大类、物料小类及物料信息？', function (result) {
            if (result) {
                $.ajax({
                    url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/MaterialStockFormatRepair',
                    type: "post",
                    success: function (r) {
                        if (r.result) {
...
<script type="text/javascript">
    function Edit_Single() {
        ...
        if (selectRow) {
            ...
            var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/MaterialStockFormatEdit/' + selectRow.id;
            $.ajax({
                url: sUrl,
                type: "post",
                dataType: "json",
        ...
        $.messager.confirm("确认", "确认提交保存?", function (r) {
            if (r) {
                $('#editStockFormatForm').form('submit', {
                    url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/MaterialStockFormatSave/' + currentId,
                    onSubmit: function () {
        ...
        $.messager.confirm("确认", "确认提交批量修改?(若确认提交批量修改，请稍等...)", function (r) {
            if (r) {
                $('#editBathStockFormatForm').form('submit', {
                    url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/BatchMaterialStockFormatSave/',
                    onSubmit: function () {
...
<script type="text/javascript">
    ...
    function Save_Choice() {
        $.messager.confirm('确认', '确认修改选择的物料？', function (result) {
            if (result) {
                var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/ChoiceMaterialStockFormatSave/';
                $.ajax({
                    url: sUrl,
                    type: "post",
                    dataType: "json",
                    data: { "releaseHeaderIds": releaseHeaderIds,
                        "zmtlCategoryStatus": $('#c_zMtlCategoryStatus').combobox('getValue'),
                        "dmtlCategoryStatus": $('#c_dMtlCategoryStatus').combobox('getValue'),
                        "wmtlCategoryStatus": $('#c_wMtlCategoryStatus').combobox('getValue')
                    },
                    success: function (r) {
                        if (r.result) {
                            $('#editChoiceStockFormat').window('close');
                            Query();
                            $('#dgStockFormat').datagrid('uncheckAll');
                        } else {
                            $.messager.alert('确认', '修改信息失败:' + r.message, 'error');
                        }
                        releaseHeaderIds = "";
                    }
                });
...
<script type="text/javascript">
    ...
    function ImportOk() {
        ...
        $('#FormUpload').form('submit', {
            url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/MaterialImport/',
            onSubmit: function () {
    ...
    function ExportExcel() {
        var data = { "queryWord": "Export",
            ...
            "zmtlCategoryStatus": $('#zStatus').combobox('getValue'),
            "dmtlCategoryStatus": $('#dStatus').combobox('getValue'),
            "wmtlCategoryStatus": $('#wStatus').combobox('getValue'),
            "queryDescribe": $('#queryDescribe').val()
        };
        var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/MaterialExport/';
