...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div region="center" title="" border="true" style="padding: 0px; overflow: auto;">
        <table id="dgMonitorTask" title="自动生成分配任务" style="" border="false" fit="true" singleSelect="false"
                                ...
                                <table id="dgJobBom" class="easyui-datagrid" title="作业日志" style="" border="false" 
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-options="field:'quantityDifference',width:60,align:'center'">
                                                差异数量
                                            </th>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#dgMonitorTask').datagrid({
                url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/GetMaterialManage/AutoTaskList',
                rownumbers: true,
                pagination: true,
                pageSize: 50,
                view: detailview,
                ...
                columns: [[
                    ...
                    { field: 'warehouserPlace', title: '仓库位置', width: 220, align: 'left' },
                ...
                onExpandRow: function (index, row) {
                    ...
                    $('#discreteJobsDetail_' + index).datagrid({
                        ...
                        columns: [[
                            ...
                            { field: 'ascmWipEntities_Name', title: '作业号', width: 70, align: 'center' },
                            { field: 'dateReleased', title: '作业日期', align: 'center', width: 60 },
                            { field: 'ascmMaterialItem_DocNumber', title: '装配件', align: 'center', width: 70 },
                            { field: 'ascmMaterialItem_Description', title: '装配件描述', align: 'left', width: 150 },
                            { field: 'netQuantity', title: '计划数量', align: 'center', width: 40 },
        ...
        function Query() {
            var queryParams = $('#dgMonitorTask').datagrid('options').queryParams;
            queryParams.queryDate = $('#queryDate').datebox('getText');
            queryParams.queryType = "bool";
            $('#dgMonitorTask').datagrid('reload');
        }
        function Search() {
            var queryParams = $('#dgMonitorTask').datagrid('options').queryParams;
            queryParams.queryDate = $('#queryDate').datebox('getText');
            queryParams.queryType = "false";
            $('#dgMonitorTask').datagrid('reload');
        }
    </script>
    <script type="text/javascript">
