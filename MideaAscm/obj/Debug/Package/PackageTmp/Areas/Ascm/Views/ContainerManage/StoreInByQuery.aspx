    ...
    <div region="center" title="" border="true" style="padding: 0px; overflow: auto;">
        <table id="dgContainer" title="容器查询列表" class="easyui-datagrid" style="" border="false"
            data-options="fit: true,
                          ...
                          pageSize: 50,
                          loadMsg: '更新数据......',
                          url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/ContainerManage/ContainerInList',
            ...
            <thead>
               <tr>
                    ...
                    <th data-options="field:'sn',width:80,align:'center'">
                        容器编号
                    </th>
                    ...
                    <th data-options="field:'supplierName',width:200,align:'left'">
                      ...
                      <th data-options="field:'ReadingHeadAddress',width:120,align:'center'">
                        位置
                    </th>
                  <%--   <th data-options="field:'description',width:80,align:'left'">
                        描述
                    </th>--%>
