...
<% YnFrame.Code.YnWebRight ynWebRight = YnFrame.Code.YnPermission.GetInstance().GetYnWebRight(); %>
    <div region="center" title="" border="true" style="padding:0px;overflow:false;">
        <table id="dgMaterialSum" title="汇总物料编码查询" class="easyui-datagrid" style="" border="false"
                        data-options="fit: true,
                          ...
                          pageSize: 50,
                          loadMsg: '更新数据...',
                          <%--url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/SumGetMaterialQuantityList',--%>
        ...
        <div id="tb1">
            ...
            <span>起止日期：</span><input class="easyui-datebox" id="queryStartDate" type="text" style="width:100px;" />-
...
<script type="text/javascript">
    ...
    function Query() {
        ...
        options.url = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/SumGetMaterialQuantityList';
