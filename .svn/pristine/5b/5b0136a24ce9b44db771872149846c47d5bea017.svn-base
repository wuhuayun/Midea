...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div region="center" title="" border="true" style="padding:0px;overflow:auto;">
		<table id="dataGridUser" title="美的用户信息管理" style="" border="false" fit="true" singleSelect="true"
    ...
    <script type="text/javascript">
        $(function () {
            $('#dataGridUser').datagrid({
                url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Public/ErpUserInfoList',
                pagination: true,
                pageSize: 50,
                loadMsg: '更新数据......',
                frozenColumns: [[
