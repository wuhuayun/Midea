...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div region="center" title="" border="false">
        <div id="ynportal" style="position: relative">
            ...
            <div style="width: 55%;">
                <div title="行业新闻" collapsible="true" style="height: 290px; padding: 5px; background: #E6E6FA;">
                    <%--Html.RenderAction("ToDoList", "Public", new { area = "Invoicing" });--%>
                </div>
                <div title="社会新闻" collapsible="true" style="height: 290px; padding: 5px; background: #E6E6FA;">
