...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div region="center" title="" border="true" style="padding: 0px; overflow: auto;">
        <table id="dgTask" title="领料任务计划管理" style="" border="false" fit="true" singleSelect="false"
                                ...
                                <table id="dgJobBom" class="easyui-datagrid" title="作业日志" style="" border="false" 
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-options="field:'ascmMaterialItem_DocNumber',width:110,align:'center'">
                                                组件
                                            </th>
...
<script type="text/javascript" src="<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Areas/YnPublic/Content/easyui/datagrid-detailview.js"></script>
    <script type="text/javascript">
        ...
        $(function () {
            $('#dgTask').datagrid({
                url: '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/GenerateLogisticsTaskPlanList',
                rownumbers: true,
                pagination: true,
                pageSize: 50,
                view: detailview,
    ...
    <script type="text/javascript">
        ...
        function GenerateTask() {
            var sUrl = '<%= Request.ApplicationPath=="/"?"":Request.ApplicationPath %>/Ascm/Logistics/GenerateLogisticsTaskPlan';
