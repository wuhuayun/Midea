...
namespace MideaAscm.Pad
{
    public partial class TaskbarNotifier : Form
    {
        ...
        protected Font hoverTitleFont = new Font("Arial", 14, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font normalContentFont = new Font("Arial", 14, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font hoverContentFont = new Font("Arial", 14, FontStyle.Bold, GraphicsUnit.Pixel);
