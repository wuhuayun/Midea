...
{
    public partial class frmDiscreteJobsDialog : DevComponents.DotNetBar.RibbonForm
    {
        private MonthCalendar monthCalendar;
        public int materialId { get; set; }

        public frmDiscreteJobsDialog()
        {
            InitializeComponent();
        }

        private void frmDiscreteJobsDialog_Load(object sender, EventArgs e)
        {
